...
function clear() { // crea una función para limpiar la pantalla

    if (PHP_OS === "WINNT") { // verifica si el sistema operativo es Windows
        system("cls"); // si es Windows, ejecuta el comando cls
    }
    else {
        system("clear");
    }
